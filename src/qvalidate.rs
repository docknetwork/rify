use crate::qprove::{BadRuleApplication, RuleApplication};
use crate::qrule::Rule;
...
mod test {
    ...
    fn bad_rule_application() {
        ...
        let rules_v1 = qdecl_rules::<&str, &str>(&[[
            &[[U("a"), B("a"), B("a"), B("a")]],
            &[[B("b"), B("b"), B("b"), B("b")]],
        ]]);
        let rules_v2 = qdecl_rules::<&str, &str>(&[[
            &[[B("a"), B("a"), B("a"), B("a")]],
            &[[B("b"), B("b"), B("b"), B("b")]],
        ]]);
